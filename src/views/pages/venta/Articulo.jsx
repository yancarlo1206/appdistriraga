...
import ArticuloVentaFormValidate from "../../../services/ArticuloVentaForm";
...
function Detail() {
    ...
    const { 
        ...
        articulos, articuloVenta, addArticuloVenta } = useContext(VentaContext);
    ...
    const {
        ...
        handleBlurCombo,
        handleSubmit,
    } = useForm(initialForm, ArticuloVentaFormValidate.validationsForm);
